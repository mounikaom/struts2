...
<body id="page-top" class="index">
                ...
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Your Message body *" id="message" required data-validation-required-message="Please enter a message."style="width: 684px; height: 183px;"></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
    ...
    <style>
        #background {
            ...
            background: url(snow.mp4) no-repeat;

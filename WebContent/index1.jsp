...
<header>
<div>
          <video id="my-video" class="video" muted loop width="99%" height="40%" z="-1">
                <source src="img/pro.mp4" type="video/mp4" >
                <source src="../pro.ogv" type="video/ogg">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="last"><a href="<%= request.getContextPath() %>/Login2.jsp"><span>Login</span></a>
...
<section id="services" class="bg-light-gray">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">ehr2ehr Services</h2>
                <h3 class="section-subheading text-muted"></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-6 ehr2ehr-item">
                <a href="img/3.png" class="portfolio-link" data-toggle="modal">
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>ehr2ehr</h4>
                                <h4 class="subheading"> ehr2ehr</h4>
                            </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; ehr2ehr 2016</span>
            </div>
            <div class="col-md-4">
                <ul class="list-inline social-buttons">
                    <li><a href="#"><i class="fa fa-twitter"></i></a>

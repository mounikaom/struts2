...
public class BMEApiMain {
	private final String username = "mounikareddy.oralla@gmail.com"; //Your Benchmark Email Login// Put in your account username
	private final String password = "ihdm123456"; //Your Benchmark Email Password// Put in your account password
	private String token = "";
	private String ListID = ""; // put in ID of any list that you wish to use below
	...
	{
	  String Mylistname = "My Team !!";//My List Created from Java Now
	  ...
	  
	  {
			...
			ListID=Output;
			System.out.println(  "ListID = " +  Output + ListID);
	  ...
	  catch ( Exception e )
	  {
			 ...
			 System.out.println(  "My Team" );  //List by that name exists
	  };

	}

	public void listAddContacts(HashMap<String,String> Contact)
	{
	  HashMap<String, String> Contacts[]=new HashMap[2];
	  Contacts[0] = new HashMap<String, String>();
	  Contacts[1] = new HashMap<String, String>();

	  Contacts[0].put("email", "mounikareddy.oralla@gmail.com");
	  Contacts[0].put("firstname", "mounika");
	  Contacts[0].put("lastname", "reddy");

	  Contacts[1].put("email", "anireddymeghana12@gmail.com");
	  Contacts[1].put("firstname", "meghana");
	  Contacts[1].put("lastname", "reddy");

	 int result =  bmServices.listAddContacts(  token,  "13945756", Contacts );
	...
	{
	  String email = "mounikareddy.oralla@gmail.com";
   ...
   public void listUpdateContactDetails()
	{
	  String email = "anireddymeghana12@gmail.com";
	  Map<Object, Object> ContactDetail = bmServices.listGetContactDetails( token,  "LISTID",  email);
	  ...
	  for ( final Object key : ContactDetail.keySet() )
		{
		 ...
		 Map<Object, Object> output = bmServices.listUpdateContactDetails( token,  "13942281",  contactID, ContactDetailFinal );
  ...
  public void listUnsubscribeContacts()
  {
   ...
   public void emailCreate()
   {
	   ...
	   emailDetail.put("fromEmail", "mounikareddy.oralla@gmail.com");
       emailDetail.put("fromName","sindhu");
       emailDetail.put("emailName","m4");
       emailDetail.put("replyEmail", "kjeevanreddy@gmail.com");
       emailDetail.put("subject", "New Products launch at our store 1");
       emailDetail.put("templateContent","<html><body> Welcome to ehr2ehr"
       		+ " Welcome to ehr2ehr<br> we are for providing Access to all qualified Professionals in Health care Domain.<br>"
       		+ "Experienced Professionals in Health Care domain for your service.<br>"
       		+ "Knowing the benefits of electronic health information systems for clinicians<br>"
       		+ "we are for providing Access to all qualified Professionals in Health care Domain.<br>"
       		+ "Experienced Professionals in Health Care domain for your service.<br>"
       		+ "Knowing the benefits of electronic health information systems for clinicians</body></html>");
       emailDetail.put("toListID",  Integer.parseInt( ListID.trim() ) );
       emailDetail.put("scheduleDate","1 july 2016 5:00pm"); /* In IST */
   ...
   {
      String TargetEmailID = "mounikareddy.oralla@gmail.com,anireddymeghana12@gmail.com";
   ...
   public void emailSendNow()
  {
   ...
   public void emailSendTest()
   {
      int pageNumber = 1;
	  int pageSize   = 1;
	  String testEmail = "bhanureddy569@gmail.com";
	  String EmailID = "";
   ...
   public void emailUpdate()
   {
	...
	public void listGetContacts()
	{
	  ...
	  Object[] Contacts = bmServices.listGetContacts( token , "13946334", "", pageNumber, pageSize, "", "");
	   int Counter = 0 ;
